...
Adresat PlikZAdresatami::pobierzDaneAdresata(string daneAdresataOddzielonePionowymiKreskami) {
    ...
    int dlugoscZmiennejZDanymiUzytkownika = daneAdresataOddzielonePionowymiKreskami.size();

    for (int pozycjaZnaku = 0; pozycjaZnaku < dlugoscZmiennejZDanymiUzytkownika; pozycjaZnaku++) {
